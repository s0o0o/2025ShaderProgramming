...
void Renderer::Initialize(int windowSizeX, int windowSizeY)
{
	...
	m_ChaTexture = CreatePngTexture("./texture0.png", GL_NEAREST);
...
void Renderer::CreateFBOs()
{
	...
	// GL_COLOR_ATTACHMENT0 0에 얘를 attach 시키고 layout = 0에 있는애랑.. 
...
void Renderer::DrawGridMesh()
{
	...
	glBindTexture(GL_TEXTURE_2D, m_ChaTexture);
...
{
	DrawTexture(-0, -0, 1, 1, m_RT0_0);
	//DrawTexture(0.5, -0.5, 0.5, 0.5, m_RT0_1);
	//DrawTexture(0, 0, 1, 1, m_RT1_0);
	//DrawTexture(0, 0, 1, 1, m_RT1_1);
}
